          ...
          fields: [
            {
              ...
              localized: true,
              admin: {
                description: "Short event summary for cards, SEO, and agent curation.",
              },
            },
            {
              name: "type",
          ...
          fields: [
            {
              ...
              fields: [
                ...
                },
                {
                  ...
                  min: 1,
                  max: 10,
                  admin: { description: "1-10 relevance score for AIT Community." },
                },
              ],
            },
            {
            ...
            },
            {
              name: "tags",
              type: "array",
              admin: { description: "Optional keyword tags for search and curation." },
            ...
            },
            {
              type: "row",
              fields: [
                { name: "curatedByAgent", type: "checkbox", defaultValue: false },
                { name: "confidenceScore", type: "number", min: 0, max: 1 },
                { name: "lastVerifiedAt", type: "date", admin: { date: { pickerAppearance: "dayAndTime" } } },
              ],
            },
            {
              name: "reviewStatus",
              ...
              admin: {
                description: "Curation lifecycle; separate from publish status so existing flows keep working.",
              },
            },
          ],
        },
          ...
          fields: [
            {
              ...
              relationTo: "media",
              admin: {
                description: "Legacy/compatible event image. Existing events continue using this.",
              },
            },
            {
              name: "coverImage",
