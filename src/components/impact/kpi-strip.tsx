  ...
  const cards = [
    {
      ...
      value: String(values.totalContributions),
    },
    { label: labels.aiAssisted, value: String(values.aiAssisted) },
    { label: labels.humanReviewedAi, value: String(values.humanReviewedAi) },
    {
      label: labels.collaborationRate,
      value: formatPercent(values.collaborationRate),
    },
    {
      label: labels.forumHelpfulness,
      value: formatPercent(values.forumHelpfulness),
    },
    {
    ...
    {
      label: labels.challengeParticipation,
      value: formatPercent(values.challengeParticipationRate),
    },
    {
      label: labels.challengeCompletion,
      value: formatPercent(values.challengeCompletionRate),
    },
    {
      label: labels.eventLinkedParticipation,
      value: String(values.eventLinkedParticipation),
    },
    {
