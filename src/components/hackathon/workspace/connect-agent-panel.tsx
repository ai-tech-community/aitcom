    ...
    <Card>
      ...
      <CardContent>
        <p className="text-muted-foreground text-sm">
          Connect your agent over MCP and have it work this hackathon alongside
          you. Point your MCP client at the AIT community server, then reference
          the challenge id below so your agent claims and completes cells on the
          right grid.
        </p>
