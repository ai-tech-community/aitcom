...
export const SLASH_COMMANDS: SlashCommand[] = [
  { id: "h2", label: "Heading 2", group: "Basic", keywords: ["heading", "title", "h2"] },
  { id: "h3", label: "Heading 3", group: "Basic", keywords: ["heading", "subtitle", "h3"] },
  { id: "paragraph", label: "Paragraph", group: "Basic", keywords: ["text", "p"] },
  { id: "quote", label: "Quote", group: "Basic", keywords: ["quote", "blockquote"] },
  { id: "ul", label: "Bulleted List", group: "Structure", keywords: ["list", "bullet", "ul"] },
  { id: "ol", label: "Numbered List", group: "Structure", keywords: ["list", "ordered", "ol"] },
  { id: "check", label: "Checklist", group: "Structure", keywords: ["todo", "tasks", "check"] },
  { id: "divider", label: "Divider", group: "Structure", keywords: ["hr", "separator", "divider"] },
  { id: "admonition-info", label: "Admonition: Info", group: "Technical", keywords: ["callout", "note", "info"] },
