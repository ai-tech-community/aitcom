      ...
      >
        ...
        >
          {rows.map((row) => {
            ...
            const crownColor =
              ranking.rank === 1 ? "text-foreground" : "text-muted-foreground"
            ...
            return (
              ...
              >
                <div className="flex w-12 items-center gap-1">
                  <span className="w-4 text-sm font-semibold font-mono tabular-nums">
                    {ranking.rank}
                  </span>
                  {showCrown ? (
                    <Crown
                ...
                <div className="flex items-center gap-2 text-right">
                  ...
                  ranking.rankChange !== 0 ? (
                    <p
                      className={cn(
                        "inline-flex items-center gap-1 text-xs font-medium font-mono tabular-nums",
                        ranking.rankChange > 0
                          ? "text-success"
                          : "text-destructive"
                      )}
                  ...
                  <p className="leading-none font-semibold font-mono tabular-nums">
          ...
          <div className="flex items-center justify-between gap-3 border-t border-border px-4 py-2">
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="bg-background text-muted-foreground rounded-md border border-border px-2 py-1 text-sm font-mono"
              >
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="hover:bg-muted rounded-md border border-border p-1.5 transition-colors disabled:cursor-not-allowed disabled:opacity-50"
              >
