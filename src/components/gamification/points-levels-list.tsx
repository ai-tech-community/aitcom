        ...
        {shouldShowProgressBar && currentLevel && nextLevel ? (
          <div className="space-y-3 border-b border-border px-4 py-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <span
                aria-hidden="true"
                className="bg-muted text-muted-foreground inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-full"
              >
                {React.createElement(
        ...
        >
          {levels.map((level, index) => {
            ...
            const nextLevelPoints =
              index < levels.length - 1 ? (levels[index + 1]?.points ?? null) : null
            ...
            return (
              ...
              >
                ...
                <span className="text-muted-foreground text-sm">
                  {isCurrentLevel ? currentLevelLabel : ""}
                </span>
              </div>
            )
          })}
