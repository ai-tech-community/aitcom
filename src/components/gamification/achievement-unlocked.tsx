      ...
      <>
        ...
        <div
          ...
          className={cn(
            ...
            "bg-card w-full max-w-md rounded-xl border border-border p-6 shadow-sm",
            className
          )}
        >
          {/* Close button */}
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <span className="text-muted-foreground mb-4 inline-flex items-center gap-1 rounded-full border border-border px-3 py-1 font-mono text-sm">
