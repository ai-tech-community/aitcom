          ...
          >
            {awards.map((award) => {
              ...
              return (
                ...
                >
                  <span className="text-muted-foreground truncate text-sm font-mono tabular-nums">
                    {formatRowDate(award.date)}
                  </span>

                  <p className="flex items-center gap-2">
                    <span className="text-foreground justify-self-center font-bold font-mono tabular-nums">
                      {totalLabel}
                    </span>
                    <span className="text-success font-medium font-mono tabular-nums">
                      {awardedLabel}
                    </span>
                  </p>
