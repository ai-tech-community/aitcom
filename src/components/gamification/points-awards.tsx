  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "bg-card border-border w-full rounded-xl border",
          className,
        )}
        {...props}
      >
          ...
          >
            {awards.map((award) => {
              ...
              return (
                ...
                >
                  <span className="text-muted-foreground truncate font-mono text-sm tabular-nums">
                    {formatRowDate(award.date)}
                  </span>

                  <p className="flex items-center gap-2">
                    <span className="text-foreground justify-self-center font-mono font-semibold tabular-nums">
                      {totalLabel}
                    </span>
