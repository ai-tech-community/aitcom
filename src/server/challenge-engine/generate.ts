...
export const challengeProposalSchema = z.object({
  ...
  collaborationModel: z.enum(["solo-ai", "relay", "swarm", "adversarial", "blind", "escalation"]).default("solo-ai"),
  ...
  signalSource: z.object({
    type: z.enum(["community-thread", "member-request", "external", "insight-gap"]),
