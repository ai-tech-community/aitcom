...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
    INSERT INTO "app"."awesome_ai_oss_project" (
      ...
      ('curated-minicpm-o', 'MiniCPM-o', 'https://github.com/OpenBMB/MiniCPM-V', 'github', 'models', 'Omni multimodal open model family from OpenBMB', 'Omni multimodale open-modelfamilie van OpenBMB', 'approved', 'curated', '2024-01-29', '2024-01-29T12:00:00Z'),
      ...
      ('curated-qwen25', 'Qwen2.5', 'https://github.com/QwenLM/Qwen3', 'github', 'models', 'Qwen2.5 open LLM family from Alibaba', 'Qwen2.5 open LLM-familie van Alibaba', 'approved', 'curated', '2024-02-05', '2024-02-05T12:00:00Z'),
