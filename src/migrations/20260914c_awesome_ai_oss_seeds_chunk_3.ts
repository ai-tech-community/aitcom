...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
    INSERT INTO "app"."awesome_ai_oss_project" (
      ...
      ('curated-sqlite-vec', 'sqlite-vec', 'https://github.com/asg017/sqlite-vec', 'github', 'rag-memory', 'Vector search extension for SQLite', 'Vectorzoek-extensie voor SQLite', 'approved', 'curated', '2024-04-20', '2024-04-20T12:00:00Z'),
      ('curated-unstructured', 'Unstructured', 'https://github.com/Unstructured-IO/unstructured', 'github', 'rag-memory', 'ETL that turns unstructured documents into LLM-ready data', 'ETL die ongestructureerde documenten omzet naar LLM-klare data', 'approved', 'curated', '2022-09-26', '2022-09-26T12:00:00Z'),
      ('curated-docling', 'Docling', 'https://github.com/docling-project/docling', 'github', 'rag-memory', 'Document conversion toolkit for PDFs and office files', 'Documentconversie-toolkit voor PDF’s en Office-bestanden', 'approved', 'curated', '2024-07-09', '2024-07-09T12:00:00Z'),
      ('curated-markitdown', 'MarkItDown', 'https://github.com/microsoft/markitdown', 'github', 'rag-memory', 'Converts files and office documents to Markdown for LLM pipelines', 'Zet bestanden en Office-documenten om naar Markdown voor LLM-pipelines', 'approved', 'curated', '2024-11-13', '2024-11-13T12:00:00Z'),
      ('curated-mineru', 'MinerU', 'https://github.com/opendatalab/MinerU', 'github', 'rag-memory', 'Parses complex PDFs/Office docs into LLM-ready Markdown/JSON', 'Zet complexe PDF’s/Office-docs om naar LLM-klare Markdown/JSON', 'approved', 'curated', '2024-02-29', '2024-02-29T12:00:00Z'),
      ('curated-sentence-transformers', 'sentence-transformers', 'https://github.com/huggingface/sentence-transformers', 'github', 'rag-memory', 'Embeddings, retrieval, and reranking for semantic search and RAG', 'Embeddings, retrieval en reranking voor semantisch zoeken en RAG', 'approved', 'curated', '2019-07-24', '2019-07-24T12:00:00Z'),
      ('curated-llamaindex', 'LlamaIndex', 'https://github.com/run-llama/llama_index', 'github', 'rag-memory', 'Data framework for connecting LLMs to private data and building RAG', 'Dataframework om LLM’s aan privédata te koppelen en RAG te bouwen', 'approved', 'curated', '2022-11-02', '2022-11-02T12:00:00Z'),
