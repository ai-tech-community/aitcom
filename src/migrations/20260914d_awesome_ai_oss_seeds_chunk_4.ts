...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
    INSERT INTO "app"."awesome_ai_oss_project" (
      ...
      ('curated-whisper-cpp', 'whisper.cpp', 'https://github.com/ggml-org/whisper.cpp', 'github', 'models', 'C++ port of OpenAI Whisper for local speech-to-text', 'C++-port van OpenAI Whisper voor lokale speech-to-text', 'approved', 'curated', '2022-09-25', '2022-09-25T12:00:00Z'),
      ...
      ('curated-axolotl', 'Axolotl', 'https://github.com/axolotl-ai-cloud/axolotl', 'github', 'models', 'Tooling to fine-tune many open LLMs', 'Tooling om veel open LLM’s te fine-tunen', 'approved', 'curated', '2023-04-14', '2023-04-14T12:00:00Z'),
      ...
      ('curated-deepspeed', 'DeepSpeed', 'https://github.com/deepspeedai/DeepSpeed', 'github', 'models', 'Deep learning optimization library for training at scale', 'Deep-learning-optimalisatiebibliotheek voor training op schaal', 'approved', 'curated', '2020-01-23', '2020-01-23T12:00:00Z')
