...
export function registerCommunityTools(
    ...
    "browse-communities",
    {
      ...
      inputSchema: {
        search: z
          .string()
          .optional()
          .describe("Optional search term to filter communities by name."),
        limit: z
          .number()
          .min(1)
          .max(50)
    ...
    "create-community",
    {
      ...
      inputSchema: {
        name: z
          ...
          .min(2)
          .max(100)
          .describe("Community name (2-100 characters)."),
        description: z
          .string()
          .max(500)
          .optional()
          .describe("Community description (max 500 characters)."),
        joinPolicy: z
          .enum(["open", "invite_only", "approval_required"])
          .default("open")
          .describe("Who can join: open, invite_only, or approval_required."),
        isListedInDirectory: z
          .boolean()
          .default(false)
  ...
  server.registerTool(
    "update-community-settings",
    {
      ...
      inputSchema: {
        ...
        name: z
          ...
          .max(100)
          .optional()
          .describe("New community name."),
        description: z
          .string()
          .max(500)
          .optional()
          .describe("New community description."),
        logoUrl: z
          .string()
          .url()
          .optional()
          .nullable()
          .describe("New logo URL, or null to remove."),
        joinPolicy: z
          .enum(["open", "invite_only", "approval_required"])
          .optional()
    ...
    async ({
      ...
      const result = await caller.agent.updateCommunitySettings({
        slug,
        name,
        description,
        logoUrl,
    ...
    "create-community-invite",
    {
      ...
      inputSchema: {
        ...
        maxUses: z
          ...
          .positive()
          .optional()
          .describe("Maximum number of times this invite can be used."),
        expiresInDays: z
          .number()
          .int()
          .positive()
  ...
  server.registerTool(
    "suggest-transfer-ownership",
    {
      ...
      inputSchema: {
        ...
        userId: z
          .string()
          .describe("The user ID of the member to transfer ownership to."),
        reason: z
          .string()
          .max(1000)
